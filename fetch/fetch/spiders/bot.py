...
class Bot(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for idx in range(1, 121):
            ...
            print("total_cases={}, new_cases={}, total_deaths={}, new_deaths={}, total_recovered={}, active_cases={}, critical={}".format(
                total_cases, new_cases, total_deaths, new_deaths, total_recovered, active_cases, critical
            ))
